                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                        <figure class="figure mb-3">
                            <img src="../../assets/images/aboutUs/ISO20000.png" class="img-fluid" alt="...">
                        </figure>
                        <p class="text-center text-primary fs-6 fw-bolder">ISO20000</p>
                    </div>
                    <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                        <figure class="figure mb-3">
                            <img src="../../assets/images/aboutUs/ISO27001.png" class="img-fluid" alt="...">
                        </figure>
                        <p class="text-center text-primary fs-6 fw-bolder">ISO27001</p>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <figure class="figure mb-3">
                            <img src="../../assets/images/aboutUs/ISO27701.png" class="img-fluid" alt="...">
                        </figure>
                        <p class="text-center text-primary fs-6 fw-bolder">ISO27701</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="py-9">
            <div class="mw-760">
                ...
                <div class="proficiency mx-xs-1_5">
                    ...
                    <h1 class="text-center">合計<span class="text-primary mx-3">300+</span>專業認證</h1>
                </div>
            </div>
        </section>
    </div>
